...
export const ProtocolSchemas: Record<string, TSchema> = {
  ...
  ModelsDefaultGetParams: ModelsDefaultGetParamsSchema,
  ModelsDefaultGetResult: ModelsDefaultGetResultSchema,
  ModelsDefaultSetParams: ModelsDefaultSetParamsSchema,
  ModelsDefaultSetResult: ModelsDefaultSetResultSchema,
  ModelsDefaultChangedEvent: ModelsDefaultChangedEventSchema,
