...
function buildAttentionItems(host: OpenClawApp) {
  ...
  if (host.lastError) {
    items.push({
      severity: "error",
      icon: "x",
      title: t("overview.attention.gatewayErrorTitle"),
  ...
  if (auth?.scopes && !auth.scopes.includes("operator.read")) {
    items.push({
      severity: "warning",
      icon: "key",
      title: t("overview.attention.missingScopeTitle"),
      description: t("overview.attention.missingScopeDescription"),
  ...
  if (missingDeps.length > 0) {
    ...
    items.push({
      severity: "warning",
      icon: "zap",
      title: t("overview.attention.missingDepsTitle"),
  ...
  if (blocked.length > 0) {
    items.push({
      severity: "warning",
      icon: "shield",
      title: t("overview.attention.blockedSkillsTitle", { count: String(blocked.length) }),
  ...
  if (failedCron.length > 0) {
    items.push({
      severity: "error",
      icon: "clock",
      title: t("overview.attention.failedCronTitle", { count: String(failedCron.length) }),
  ...
  if (overdue.length > 0) {
    items.push({
      severity: "warning",
      icon: "clock",
      title: t("overview.attention.overdueJobsTitle", { count: String(overdue.length) }),
