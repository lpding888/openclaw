        ...
        <div class="cfg-field">
          ...
          <div class="cfg-segmented">
            ${literals.map(
              ...
              <button
                type="button"
                class="cfg-segmented__btn ${lit === resolvedValue || toDisplayText(lit) === toDisplayText(resolvedValue) ? "active" : ""}"
                ?disabled=${disabled}
        ...
        <div class="cfg-field">
          ...
          <div class="cfg-segmented">
            ${options.map(
              ...
              <button
                type="button"
                class="cfg-segmented__btn ${opt === resolvedValue || toDisplayText(opt) === toDisplayText(resolvedValue) ? "active" : ""}"
                ?disabled=${disabled}
...
function renderTextInput(params: {
  ...
  const help = hint?.help ?? schema.description;
  const isSensitive =
    (hint?.sensitive ?? false) && !/^\$\{[^}]*\}$/.test(toDisplayText(value).trim());
  const placeholder =
    hint?.placeholder ??
    (isSensitive
      ? "••••"
      : schema.default !== undefined
        ? `Default: ${toDisplayText(schema.default)}`
        : "");
    ...
    <div class="cfg-field">
      ...
      <div class="cfg-input-wrap">
        <input
          ...
          .value=${toDisplayText(displayValue)}
          ?disabled=${disabled}
          @input=${(e: Event) => {
...
function renderSelect(params: {
  ...
  const currentIndex = options.findIndex(
    (opt) => opt === resolvedValue || toDisplayText(opt) === toDisplayText(resolvedValue),
  );
  ...
  return html`
    <div class="cfg-field">
      ...
      >
        ...
        ${options.map(
          (opt, idx) => html`
          <option value=${String(idx)}>${toDisplayText(opt)}</option>
        `,
        )}
      </select>
    </div>
